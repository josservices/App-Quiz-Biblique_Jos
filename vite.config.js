...
export default defineConfig({
                ...
                runtimeCaching: [
                    {
                        urlPattern: function (_a) {
                            var url = _a.url;
                            return /\/assets\/.*-(normal|difficile)-.*\.js$/.test(url.pathname);
                        },
                        handler: 'CacheFirst',
                        options: {
                    ...
                    },
                    {
                        urlPattern: function (_a) {
                            var url = _a.url;
                            return /\/assets\/generalites-.*\.js$/.test(url.pathname);
                        },
                        handler: 'CacheFirst',
                        options: {
                    ...
                    },
                    {
                        urlPattern: function (_a) {
                            var url = _a.url;
                            return /\/data\/questions\/.*\.json$/.test(url.pathname);
                        },
    ...
    define: {
        'import.meta.env.SITE_URL': JSON.stringify((_a = process.env.SITE_URL) !== null && _a !== void 0 ? _a : '')
    },
    server: {
        host: '127.0.0.1',
        port: 5173
